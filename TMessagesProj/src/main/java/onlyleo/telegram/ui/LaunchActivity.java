...
import onlyleo.telegram.messenger.LocationController;
...
import onlyleo.telegram.messenger.NativeCrashManager;
...
import onlyleo.telegram.messenger.camera.CameraController;
...
import onlyleo.telegram.ui.ActionBar.DrawerLayoutContainer;
import onlyleo.telegram.ui.ActionBar.Theme;
import onlyleo.telegram.ui.Adapters.DrawerLayoutAdapter;
import onlyleo.telegram.ui.Cells.LanguageCell;
import onlyleo.telegram.ui.Components.AlertsCreator;
import onlyleo.telegram.ui.Components.AudioPlayerAlert;
...
import onlyleo.telegram.ui.Components.PasscodeView;
import onlyleo.telegram.ui.Components.PipRoundVideoView;
import onlyleo.telegram.ui.Components.RecyclerListView;
import onlyleo.telegram.ui.Components.SharingLocationsAlert;
import onlyleo.telegram.ui.Components.StickersAlert;
import onlyleo.telegram.ui.Components.ThemeEditorView;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("onlyleo.telegram.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;
