 ...
 */
package onlyleo.telegram.messenger.exoplayer2.source.smoothstreaming.manifest;
...
import onlyleo.telegram.messenger.exoplayer2.util.CodecSpecificDataUtil;
...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
  ...
  private static class SmoothStreamingMediaParser extends ElementParser {
    ...
    public Object build() {
      ...
      if (protectionElement != null) {
        DrmInitData drmInitData = new DrmInitData(new DrmInitData.SchemeData(protectionElement.uuid, null,
  ...
  private static class StreamIndexParser extends ElementParser {
    ...
    public Object build() {
      ...
      return new SsManifest.StreamElement(baseUri, url, type, subType, timescale, name, maxWidth, maxHeight,
