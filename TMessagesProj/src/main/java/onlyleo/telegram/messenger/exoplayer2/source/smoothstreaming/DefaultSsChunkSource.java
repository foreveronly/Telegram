 ...
 */
package onlyleo.telegram.messenger.exoplayer2.source.smoothstreaming;
...
import onlyleo.telegram.messenger.exoplayer2.extractor.mp4.Track;
import onlyleo.telegram.messenger.exoplayer2.extractor.mp4.TrackEncryptionBox;
...
import onlyleo.telegram.messenger.exoplayer2.source.smoothstreaming.manifest.SsManifest;
import onlyleo.telegram.messenger.exoplayer2.source.smoothstreaming.manifest.SsManifest.StreamElement;
...
public class DefaultSsChunkSource implements SsChunkSource {
  ...
  public void updateManifest(SsManifest newManifest) {
    SsManifest.StreamElement currentElement = manifest.streamElements[elementIndex];
    int currentElementChunkCount = currentElement.chunkCount;
    SsManifest.StreamElement newElement = newManifest.streamElements[elementIndex];
