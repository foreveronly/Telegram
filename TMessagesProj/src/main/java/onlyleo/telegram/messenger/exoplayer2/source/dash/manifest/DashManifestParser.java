 ...
 */
package onlyleo.telegram.messenger.exoplayer2.source.dash.manifest;
...
import onlyleo.telegram.messenger.exoplayer2.extractor.mp4.PsshAtomUtil;
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentList;
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentTemplate;
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.SegmentBase.SegmentTimelineElement;
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.SegmentBase.SingleSegmentBase;
...
import onlyleo.telegram.messenger.exoplayer2.util.XmlPullParserUtil;
...
public class DashManifestParser extends DefaultHandler
   ...
   * @return {@link DrmInitData.SchemeData} parsed from the ContentProtection element, or null if the element is
   *     unsupported.
   */
  protected DrmInitData.SchemeData parseContentProtection(XmlPullParser xpp) throws XmlPullParserException,
    ...
    return data != null
        ? new DrmInitData.SchemeData(uuid, schemeType, MimeTypes.VIDEO_MP4, data, requiresSecureDecoder) : null;
  }
  ...
  protected Representation buildRepresentation(RepresentationInfo representationInfo,
      String contentId, ArrayList<DrmInitData.SchemeData> extraDrmSchemeDatas,
  ...
  private static final class RepresentationInfo {
    ...
    public RepresentationInfo(Format format, String baseUrl, SegmentBase segmentBase,
                              ArrayList<DrmInitData.SchemeData> drmSchemeDatas, ArrayList<Descriptor> inbandEventStreams) {
      this.format = format;
