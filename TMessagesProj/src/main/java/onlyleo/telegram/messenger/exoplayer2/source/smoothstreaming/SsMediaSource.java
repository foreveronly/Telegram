...
import onlyleo.telegram.messenger.exoplayer2.source.SinglePeriodTimeline;
...
import onlyleo.telegram.messenger.exoplayer2.source.smoothstreaming.manifest.SsManifestParser;
...
public final class SsMediaSource implements MediaSource,
  ...
  private void processManifest() {
    ...
    for (SsManifest.StreamElement element : manifest.streamElements) {
