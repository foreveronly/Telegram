...
import onlyleo.telegram.messenger.exoplayer2.ExoPlayer.ExoPlayerMessage;
import onlyleo.telegram.messenger.exoplayer2.MediaPeriodInfoSequence.MediaPeriodInfo;
import onlyleo.telegram.messenger.exoplayer2.source.ClippingMediaPeriod;
...
import onlyleo.telegram.messenger.exoplayer2.source.MediaSource.MediaPeriodId;
...
import onlyleo.telegram.messenger.exoplayer2.trackselection.TrackSelectorResult;
import onlyleo.telegram.messenger.exoplayer2.util.Assertions;
import onlyleo.telegram.messenger.exoplayer2.util.MediaClock;
import onlyleo.telegram.messenger.exoplayer2.util.StandaloneMediaClock;
...
/* package */ final class ExoPlayerImplInternal implements Handler.Callback,
  ...
  private static final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(Renderer[] renderers, RendererCapabilities[] rendererCapabilities,
        ...
        MediaSource mediaSource, Object periodUid, int index, MediaPeriodInfoSequence.MediaPeriodInfo info) {
      this.renderers = renderers;
