 ...
 */
package onlyleo.telegram.messenger.exoplayer2;
...
import onlyleo.telegram.messenger.exoplayer2.audio.AudioCapabilities;
import onlyleo.telegram.messenger.exoplayer2.audio.AudioProcessor;
import onlyleo.telegram.messenger.exoplayer2.audio.AudioRendererEventListener;
import onlyleo.telegram.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
...
import onlyleo.telegram.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import onlyleo.telegram.messenger.exoplayer2.metadata.MetadataRenderer;
import onlyleo.telegram.messenger.exoplayer2.text.TextRenderer;
import onlyleo.telegram.messenger.exoplayer2.trackselection.TrackSelector;
import onlyleo.telegram.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import onlyleo.telegram.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("onlyleo.telegram.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("onlyleo.telegram.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("onlyleo.telegram.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("onlyleo.telegram.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
