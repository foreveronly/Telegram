...
import onlyleo.telegram.messenger.exoplayer2.source.UnrecognizedInputFormatException;
  ...
  private static HlsMediaPlaylist parseMediaPlaylist(LineIterator iterator, String baseUri)
    ...
    while (iterator.hasNext()) {
      ...
      if (line.startsWith(TAG_PLAYLIST_TYPE)) {
        ...
        segments.add(new HlsMediaPlaylist.Segment(line, segmentDurationUs, relativeDiscontinuitySequence,
