 ...
 */
package onlyleo.telegram.messenger.exoplayer2.source.hls.playlist;

import android.net.Uri;
import android.os.Handler;
import android.os.SystemClock;
import onlyleo.telegram.messenger.exoplayer2.C;
import onlyleo.telegram.messenger.exoplayer2.ParserException;
import onlyleo.telegram.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import onlyleo.telegram.messenger.exoplayer2.source.chunk.ChunkedTrackBlacklistUtil;
import onlyleo.telegram.messenger.exoplayer2.source.hls.HlsDataSourceFactory;
import onlyleo.telegram.messenger.exoplayer2.source.hls.playlist.HlsMasterPlaylist.HlsUrl;
import onlyleo.telegram.messenger.exoplayer2.source.hls.playlist.HlsMediaPlaylist.Segment;
import onlyleo.telegram.messenger.exoplayer2.upstream.DataSource;
import onlyleo.telegram.messenger.exoplayer2.upstream.Loader;
import onlyleo.telegram.messenger.exoplayer2.upstream.ParsingLoadable;
import onlyleo.telegram.messenger.exoplayer2.util.UriUtil;
...
import onlyleo.telegram.messenger.exoplayer2.C;
import onlyleo.telegram.messenger.exoplayer2.ParserException;
import onlyleo.telegram.messenger.exoplayer2.source.AdaptiveMediaSourceEventListener;
import onlyleo.telegram.messenger.exoplayer2.source.hls.HlsDataSourceFactory;
import onlyleo.telegram.messenger.exoplayer2.util.UriUtil;
...
public final class HlsPlaylistTracker implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
  ...
  public HlsPlaylistTracker(Uri initialPlaylistUri, HlsDataSourceFactory dataSourceFactory,
                            AdaptiveMediaSourceEventListener.EventDispatcher eventDispatcher, int minRetryCount,
   ...
   * {@link HlsMasterPlaylist.HlsUrl}.
   *
   * @param url The {@link HlsMasterPlaylist.HlsUrl} corresponding to the requested media playlist.
   * @return The most recent snapshot of the playlist referenced by the provided {@link HlsMasterPlaylist.HlsUrl}. May
  ...
  /**
   * Returns whether the snapshot of the playlist referenced by the provided {@link HlsMasterPlaylist.HlsUrl} is
   ...
   * @param url The {@link HlsMasterPlaylist.HlsUrl}.
   * @return Whether the snapshot of the playlist referenced by the provided {@link HlsMasterPlaylist.HlsUrl} is
   *     valid.
   */
   ...
   * {@link HlsMasterPlaylist.HlsUrl}, this method throws the underlying error.
   *
   * @param url The {@link HlsMasterPlaylist.HlsUrl}.
   ...
   *
   * @param url The {@link HlsMasterPlaylist.HlsUrl} of the playlist to be refreshed.
   */
  ...
  private void notifyPlaylistBlacklisting(HlsMasterPlaylist.HlsUrl url, long blacklistMs) {
    int listenersSize = listeners.size();
    for (int i = 0; i < listenersSize; i++) {
  ...
  private static HlsMediaPlaylist.Segment getFirstOldOverlappingSegment(HlsMediaPlaylist oldPlaylist,
                                                                        HlsMediaPlaylist loadedPlaylist) {
