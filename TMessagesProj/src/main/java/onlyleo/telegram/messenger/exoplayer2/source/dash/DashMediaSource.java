...
import onlyleo.telegram.messenger.exoplayer2.ExoPlayerLibraryInfo;
...
import onlyleo.telegram.messenger.exoplayer2.source.MediaPeriod;
...
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.DashManifestParser;
import onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.UtcTimingElement;
...
public final class DashMediaSource implements MediaSource {
  ...
  private DashMediaSource(DashManifest manifest, Uri manifestUri,
    ...
    eventDispatcher = new AdaptiveMediaSourceEventListener.EventDispatcher(eventHandler, eventListener);
  ...
  public MediaPeriod createPeriod(MediaPeriodId periodId, Allocator allocator) {
    ...
    AdaptiveMediaSourceEventListener.EventDispatcher periodEventDispatcher = eventDispatcher.copyWithMediaTimeOffsetMs(
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
        onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      onlyleo.telegram.messenger.exoplayer2.source.dash.manifest.Period period =
