...
import onlyleo.telegram.messenger.exoplayer2.ExoPlayer.ExoPlayerComponent;
...
public final class DynamicConcatenatingMediaSource implements MediaSource, ExoPlayer.ExoPlayerComponent {
  ...
  public synchronized void addMediaSource(int index, MediaSource mediaSource) {
    ...
    if (player != null) {
      player.sendMessages(new ExoPlayer.ExoPlayerMessage(this, MSG_ADD, Pair.create(index, mediaSource)));
    }
  }
  ...
  public synchronized void addMediaSources(int index, Collection<MediaSource> mediaSources) {
    ...
    if (player != null && !mediaSources.isEmpty()) {
      player.sendMessages(new ExoPlayer.ExoPlayerMessage(this, MSG_ADD_MULTIPLE,
  ...
  public synchronized void removeMediaSource(int index) {
    ...
    if (player != null) {
      player.sendMessages(new ExoPlayer.ExoPlayerMessage(this, MSG_REMOVE, index));
    }
  }
  ...
  public synchronized void moveMediaSource(int currentIndex, int newIndex) {
    ...
    if (player != null) {
      player.sendMessages(new ExoPlayer.ExoPlayerMessage(this, MSG_MOVE,
