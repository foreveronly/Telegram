 ...
 */
package onlyleo.telegram.messenger.exoplayer2.extractor.mp4;
...
import onlyleo.telegram.messenger.exoplayer2.drm.DrmInitData;
import onlyleo.telegram.messenger.exoplayer2.drm.DrmInitData.SchemeData;
...
import onlyleo.telegram.messenger.exoplayer2.extractor.ExtractorInput;
import onlyleo.telegram.messenger.exoplayer2.extractor.ExtractorOutput;
import onlyleo.telegram.messenger.exoplayer2.extractor.ExtractorsFactory;
import onlyleo.telegram.messenger.exoplayer2.extractor.PositionHolder;
import onlyleo.telegram.messenger.exoplayer2.extractor.SeekMap;
import onlyleo.telegram.messenger.exoplayer2.extractor.TrackOutput;
import onlyleo.telegram.messenger.exoplayer2.extractor.mp4.Atom.ContainerAtom;
import onlyleo.telegram.messenger.exoplayer2.extractor.mp4.Atom.LeafAtom;
import onlyleo.telegram.messenger.exoplayer2.text.cea.CeaUtil;
import onlyleo.telegram.messenger.exoplayer2.util.Assertions;
import onlyleo.telegram.messenger.exoplayer2.util.MimeTypes;
import onlyleo.telegram.messenger.exoplayer2.util.NalUnitUtil;
import onlyleo.telegram.messenger.exoplayer2.util.ParsableByteArray;
import onlyleo.telegram.messenger.exoplayer2.util.TimestampAdjuster;
    ...
    for (int i = 0; i < leafChildrenSize; i++) {
      ...
      if (child.type == Atom.TYPE_pssh) {
        ...
        if (uuid == null) {
          ...
          schemeDatas.add(new DrmInitData.SchemeData(uuid, null, MimeTypes.VIDEO_MP4, psshData));
        }
      }
    }
