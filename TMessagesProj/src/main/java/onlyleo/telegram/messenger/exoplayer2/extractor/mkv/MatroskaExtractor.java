 ...
 */
package onlyleo.telegram.messenger.exoplayer2.extractor.mkv;
...
import onlyleo.telegram.messenger.exoplayer2.extractor.MpegAudioHeader;
...
import onlyleo.telegram.messenger.exoplayer2.util.LongArray;
...
import onlyleo.telegram.messenger.exoplayer2.video.AvcConfig;
import onlyleo.telegram.messenger.exoplayer2.video.ColorInfo;
import onlyleo.telegram.messenger.exoplayer2.video.HevcConfig;
    ...
    switch (id) {
      ...
      case ID_CONTENT_ENCODING:
        if (currentTrack.hasContentEncryption) {
          ...
          currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C.UUID_NIL, null,
