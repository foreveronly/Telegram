...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "onlyleo.telegram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "onlyleo.telegram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "onlyleo.telegram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "onlyleo.telegram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "onlyleo.telegram.android.musicplayer.next";
