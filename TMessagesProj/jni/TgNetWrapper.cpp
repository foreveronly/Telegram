...
static const char *FileLoadOperationClassPathName = "onlyleo/telegram/tgnet/FileLoadOperation";
...
static const char *NativeByteBufferClassPathName = "onlyleo/telegram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "onlyleo/telegram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILonlyleo/telegram/tgnet/RequestDelegateInternal;Lonlyleo/telegram/tgnet/QuickAckDelegate;Lonlyleo/telegram/tgnet/WriteToSocketDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("onlyleo/telegram/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("onlyleo/telegram/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_WriteToSocketDelegate = (jclass) env->NewGlobalRef(env->FindClass("onlyleo/telegram/tgnet/WriteToSocketDelegate"));
    ...
    jclass_FileLoadOperationDelegate = (jclass) env->NewGlobalRef(env->FindClass("onlyleo/telegram/tgnet/FileLoadOperationDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("onlyleo/telegram/tgnet/ConnectionsManager"));
